...
namespace RPA.Infrastructure.Migrations
{
    ...
    [Migration("20260717082442_AddRobotAgentOwnership")]
    partial class AddRobotAgentOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPA.Domain.Entities.EInvoiceProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RPA.Domain.Entities.EInvoiceProfileVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EInvoiceProfileVersions");
                });
            ...
            modelBuilder.Entity("RPA.Domain.Entities.EInvoiceProfile", b =>
                {
                    b.HasOne("RPA.Domain.Entities.Project", "Project")
                        .WithMany("EInvoiceProfiles")
            ...
            modelBuilder.Entity("RPA.Domain.Entities.EInvoiceProfileVersion", b =>
                {
                    b.HasOne("RPA.Domain.Entities.EInvoiceProfile", "Profile")
                        .WithMany("Versions")
